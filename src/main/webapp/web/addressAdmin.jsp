				...
				<form id="add_form" method="post" action="">
					...
					<div class="address_content">
						<span class="red">*</span><span class="kuan">省&nbsp;&nbsp;份：</span><select
							data-province="---- 选择省 ----" name="receiverState"
							id="receiverState" onchange="getCity(this.value,-1,-1)"></select> 城市：<select
							data-city="---- 选择市 ----" name="receiverCity" id="receiverCity"
							onchange="getArea(this.value,-1)"></select> 区/县：<select
							data-district="---- 选择区 ----" name="receiverDistrict"
							id="receiverDistrict"></select>
					</div>
...
<script type="text/javascript">
    ...
    $("#leftsidebar_box .address").parent().find('img').attr("src","../images/myOrder/myOrder1.png");
	})
</script>
</html>